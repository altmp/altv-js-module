...
static void IsTextureExistInArchetype(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    V8_ARG_TO_STRING(2, targetTextureName);

    V8_RETURN_BOOLEAN(nullptr != ICore::Instance().GetTextureFromDrawable(modelHash, targetTextureName));
}
...
extern V8Class v8Player, v8Player, v8Vehicle, v8WebView, v8Blip, v8AreaBlip, v8RadiusBlip, v8PointBlip, v8HandlingData, v8LocalStorage, v8MemoryBuffer, v8MapZoomData, v8Discord, v8Voice,
  v8PedBlip, v8VehicleBlip, v8WebSocketClient, v8Checkpoint, v8HttpClient, v8Audio, v8LocalPlayer, v8Profiler;
extern V8Module altModule("alt",
                          &sharedModule,
                          { v8Player,       v8Vehicle,     v8WebView, v8Blip,  v8AreaBlip,        v8RadiusBlip, v8PointBlip,  v8PedBlip, v8VehicleBlip, v8HandlingData, v8LocalStorage,
                            v8MemoryBuffer, v8MapZoomData, v8Discord, v8Voice, v8WebSocketClient, v8Checkpoint, v8HttpClient, v8Audio,   v8LocalPlayer, v8Profiler },
