...
// 	alt::Ref<CNetworkPlayer> player = _this->GetHandle().As<CNetworkPlayer>();

// 	info.GetReturnValue().Set(v8::String::NewFromUtf8(isolate, player->GetName().c_str()).ToLocalChecked());
// }
...
// 	alt::Ref<CNetworkPlayer> player = _this->GetHandle().As<CNetworkPlayer>();
// 	alt::Ref<CNetworkVehicle> vehicle = player->GetVehicle();
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		ped->ikManager.pedInventory->AddWeapon(weaponHash, ammoCount);
// }
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		info.GetReturnValue().Set(v8::Boolean::New(info.GetIsolate(), ped->ikManager.pedInventory->RemoveWeapon(weaponHash)));
// 	else
...
// 	if (ped)
// 	{
// 		CPedInventory::RemoveAllWeapons(ped);
// 	}
// }
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		ped->ikManager.pedInventory->AddWeaponComponent(weaponHash, componentHash);
// }
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		ped->ikManager.pedInventory->RemoveWeaponComponent(weaponHash, componentHash);
// }
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		info.GetReturnValue().Set(v8::Boolean::New(info.GetIsolate(), ped->ikManager.pedInventory->WeaponHasComponent(weaponHash, componentHash)));
// 	else
// 		info.GetReturnValue().Set(v8::Boolean::New(info.GetIsolate(), false));
// }
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		ped->ikManager.pedInventory->SetWeaponTintIndex(weaponHash, tintIndex);
// }
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		info.GetReturnValue().Set(v8::Number::New(info.GetIsolate(), ped->ikManager.pedInventory->GetWeaponTintIndex(weaponHash)));
// 	else
// 		info.GetReturnValue().Set(v8::Number::New(info.GetIsolate(), false));
// }
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		ped->ikManager.pedWeaponManager->SetCurrentWeapon(weaponHash, false);
// }
...
// 	CPed *ped = player->GetGamePed();
// 	if (ped)
// 		info.GetReturnValue().Set(v8::Number::New(info.GetIsolate(), ped->ikManager.pedWeaponManager->currentWeaponHash));
// 	else
...
// 	uint16_t i = 0;
// 	CGame::Instance().GetEntityManager().ForEach([&](alt::Ref<alt::IEntity> ent) {
// 		auto player = ent.As<CNetworkPlayer>();
...
// 	auto localPlayer = CGame::Instance().GetLocalPlayer();
// 	if (!localPlayer)
...
// 	V8_RETURN_BASE_OBJECT(alt::ICore::Instance().GetEntityByScriptGuid(scriptGuid).As<CNetworkPlayer>());
// }
...
// 	V8_RETURN_BASE_OBJECT(alt::ICore::Instance().GetEntityByID(id).As<CNetworkPlayer>());
// }
