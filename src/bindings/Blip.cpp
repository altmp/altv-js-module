...
// #include "script-objects/CBlip.h"
...
// 	alt::Ref<alt::CBlip> blip = alt::CBlip::CreateBlipForArea({x->Value(), y->Value(), z->Value()}, width->Value(), height->Value());
...
// 	alt::Ref<alt::CBlip> blip = alt::CBlip::CreateBlipForRadius({x->Value(), y->Value(), z->Value()}, radius->Value());
...
// 	v8::Local<v8::Number> y = info[1]->ToNumber(ctx).ToLocalChecked();
// 	v8::Local<v8::Number> z = info[2]->ToNumber(ctx).ToLocalChecked();
// 	alt::Ref<alt::CBlip> blip = alt::CBlip::Create(alt::IBlip::BlipType::DESTINATION, {x->Value(), y->Value(), z->Value()});
...
// 	alt::Ref<alt::CBlip> blip = alt::CBlip::CreateBlipForEntity(alt::IBlip::BlipType::PED, pedId);
...
// 	alt::Ref<alt::CBlip> blip = alt::CBlip::CreateBlipForEntity(alt::IBlip::BlipType::VEHICLE, vehicleId);
...
// //    auto ctx = isolate->GetEnteredContext();
// //
// //	alt::Ref<alt::CBlip> blip = (alt::Ref<alt::CBlip>)info.This()->GetInternalField(0).As<v8::External>()->Value();
// //
...
// 	alt::Ref<alt::CBlip> blip = _this->GetHandle().As<alt::CBlip>();
