...
//     alt::Ref<CNetworkVehicle> vehicle = _this->GetHandle().As<CNetworkVehicle>();
...
//     auto vehicle = _this->GetHandle().As<CNetworkVehicle>()->GetGameVehicle();
...
//     uint16_t i = 0;
//     CGame::Instance().GetEntityManager().ForEach([&](Ref<alt::IEntity> ent) {
//         auto vehicle = ent.As<CNetworkVehicle>();
...
//     V8_RETURN_BASE_OBJECT(alt::ICore::Instance().GetEntityByScriptGuid(scriptGuid).As<CNetworkVehicle>());
// }
...
//     V8_RETURN_BASE_OBJECT(alt::ICore::Instance().GetEntityByID(id).As<CNetworkVehicle>());
// }
