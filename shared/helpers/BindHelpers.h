...
namespace V8Helpers
{
    namespace detail
    {
        ...
        V8_CALL_GETTER(alt::Quaternion, V8_GET_ISOLATE_CONTEXT_RESOURCE, V8_RETURN_QUATERNION);
        ...
        V8_CALL_GETTER(alt::ILocalObject*, V8_GET_ISOLATE_CONTEXT_RESOURCE, V8_RETURN_BASE_OBJECT);
        V8_CALL_GETTER(alt::IVirtualEntity*, V8_GET_ISOLATE_CONTEXT_RESOURCE, V8_RETURN_BASE_OBJECT);
        V8_CALL_GETTER(alt::IVirtualEntityGroup*, V8_GET_ISOLATE_CONTEXT_RESOURCE, V8_RETURN_BASE_OBJECT);
        ...
        V8_CALL_SETTER(alt::Quaternion, V8_GET_ISOLATE_CONTEXT, V8_TO_QUATERNION);
