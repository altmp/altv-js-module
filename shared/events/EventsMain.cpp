...
V8_LOCAL_EVENT_HANDLER baseObjectCreate(EventType::CREATE_BASE_OBJECT_EVENT, "baseObjectCreate", [](V8ResourceImpl* resource, const alt::CEvent* e, std::vector<v8::Local<v8::Value>>& args) {
...
V8_LOCAL_EVENT_HANDLER baseObjectRemove(EventType::REMOVE_BASE_OBJECT_EVENT, "baseObjectRemove", [](V8ResourceImpl* resource, const alt::CEvent* e, std::vector<v8::Local<v8::Value>>& args) {
