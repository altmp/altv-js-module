...
namespace V8
{
	namespace detail
	{
		...
		V8_CALL_GETTER(uint8_t, V8_GET_ISOLATE, V8_RETURN_UINTEGER);
		V8_CALL_GETTER(uint16_t, V8_GET_ISOLATE, V8_RETURN_UINTEGER);
		V8_CALL_GETTER(uint32_t, V8_GET_ISOLATE, V8_RETURN_UINTEGER);
		V8_CALL_GETTER(uint64_t, V8_GET_ISOLATE, V8_RETURN_UINT64);
		V8_CALL_GETTER(int8_t, V8_GET_ISOLATE, V8_RETURN_INTEGER);
		V8_CALL_GETTER(int16_t, V8_GET_ISOLATE, V8_RETURN_INTEGER);
		V8_CALL_GETTER(int32_t, V8_GET_ISOLATE, V8_RETURN_INTEGER);
