...
static V8Class v8RGBA("RGBA", "", [](const v8::FunctionCallbackInfo<v8::Value>& info) {
	v8::Isolate* isolate = info.GetIsolate();
	v8::Local<v8::Context> ctx = isolate->GetEnteredContext();
	...
	V8::DefineOwnProperty(isolate, ctx, _this, V8::RGBA_AKey(isolate), a, v8::PropertyAttribute::ReadOnly);
