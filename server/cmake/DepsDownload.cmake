...
function(DownloadDeps basePath)
    ...
    set(__deps_lib_linux "${basePath}/nodejs/lib/libnode.so.102")
    ...
    if(__deps_check_enabled)
        ...
        if(WIN32)
            ...
            string(JSON __deps_release_checksum_cdn GET ${__deps_hashes} libnode.lib)
            ...
            string(JSON __deps_release_dll_checksum_cdn GET ${__deps_hashes} libnode.dll)
            ...
            if(CMAKE_BUILD_TYPE STREQUAL "Debug")
                ...
                string(JSON __deps_debug_checksum_cdn GET ${__deps_hashes} libnode.lib)
                ...
                string(JSON __deps_debug_dll_checksum_cdn GET ${__deps_hashes} libnode.dll)
        ...
        elseif(UNIX)
            if(EXISTS ${__deps_lib_linux})
                file(SHA1 ${__deps_lib_linux} __deps_linux_checksum)
            else()
                set(__deps_linux_checksum 0)
            endif()
            string(JSON __deps_linux_checksum_cdn GET ${__deps_hashes} libnode.so.102)
            if(NOT ${__deps_linux_checksum} STREQUAL ${__deps_linux_checksum_cdn})
                message("Downloading binaries...")
                file(DOWNLOAD "${__deps_url_base_path}/libnode.so.102" ${__deps_lib_linux})
            endif()
        endif()
    endif()
endfunction()
