...
static void PointConstructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if(blip) resource->BindEntity(info.This(), blip.Get());
    else
...
extern V8Class v8PointBlip("PointBlip", v8Blip, PointConstructor, [](v8::Local<v8::FunctionTemplate> tpl) { v8::Isolate* isolate = v8::Isolate::GetCurrent(); });
